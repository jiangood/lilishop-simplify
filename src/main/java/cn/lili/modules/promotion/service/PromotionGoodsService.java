 ...
 */
@Service
public class PromotionGoodsService extends ServiceImpl<PromotionGoodsMapper, PromotionGoods>  {
     ...
     * @return 缓存商品库存key
     */
    public static String getPromotionGoodsStockCacheKey(PromotionTypeEnum typeEnum, String promotionId, String skuId) {
