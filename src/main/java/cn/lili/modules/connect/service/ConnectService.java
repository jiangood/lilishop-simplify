...
@Slf4j
@Service
public class ConnectService extends ServiceImpl<ConnectMapper, Connect>  {

    /**
     * 联合登陆cookie 常量
     */
  public static  final  String CONNECT_COOKIE = "CONNECT_COOKIE";
    /**
     * 联合登陆cookie 常量
     */
     ...
     * @return 返回KEY
     */
    public static String cacheKey(String type, String uuid) {
